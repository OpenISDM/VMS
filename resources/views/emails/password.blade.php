...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
			...
			/*////// GENERAL STYLES //////*/
			body, #bodyTable{background-color:#EDEDEE;}
			...
			.emailButton{background-color:#E74C40; border-collapse:separate; border-radius:4px;}
    ...
    <body>
    	<center>
        	<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <h3>重設密碼</h3>
                                                                        <br />
                                                                        <p>Hi, {{ $user->last_password }}</p>
                                                                        <p>您要求重設密碼，請點擊下方按鈕來重設您的密碼。</p>
                                                                        <p>如無法點擊按鈕，請複製此連結：<a href="{{ $verificationUrl }}">{{ $verificationUrl }}</p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent">
                                                                        <a href="{{ config('APP_URL') . /users/password_reset/ . $token }}" target="_blank">重設密碼</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="600" class="flexibleContainerCell">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <h3 class="main-title">感謝您加入我們！</h3>
                                                                        <br />
                                                                        <p>Hi, {{ $name }}</p>
                                                                        <p>感謝您註冊 VMS，未來我們將持續更新。</p>
                                                                        <p>如有任何問題歡迎來信 <a href="mailto:volunteer.service.tw@gmail.com">volunteer.service.tw@gmail.com</a> 詢問。</p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                ...
                <tr>
                    <td align="center">
                        <span class="text-muted">The template by <a target="_blank" href="https://github.com/mailchimp/email-blueprints">Mailchimp</a> is licensed under <a target="_blank" href="http://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA 3.0</a></span>
                    </td>
                </tr>
            </table>
        </center>
